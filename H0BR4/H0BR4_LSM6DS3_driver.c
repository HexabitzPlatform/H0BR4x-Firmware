...
extern uint8_t LSM6DS3_I2C_Write(void *handle, uint8_t WriteAddr, uint8_t *pBuffer, uint16_t nBytesToWrite);
extern uint8_t LSM6DS3_I2C_Read(void *handle, uint8_t ReadAddr, uint8_t *pBuffer, uint16_t nBytesToRead);
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL3_C, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
/*******************************************************************************
* Function Name  : status_t LSM6DS3_ACC_GYRO_GetRawAccData(uint8_t *buff)
...
/*******************************************************************************
* Function Name  : status_t LSM6DS3_ACC_Get_Acceleration(void *handle, int *buff, uint8_t from_fifo)
* Description    : Read GetAccData output register
* Input          : pointer to [uint8_t]
...
status_t LSM6DS3_ACC_Get_Acceleration(void *handle, int *buff, uint8_t from_fifo)
{
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_translate_ODR_XL(LSM6DS3_ACC_GYRO_ODR_XL_t value, uint16_t *odr_hz_val)
{
  switch(value)
  {
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_translate_ODR_G(LSM6DS3_ACC_GYRO_ODR_G_t value, uint16_t *odr_hz_val)
{
  switch(value)
  {
...
/*******************************************************************************
* Function Name  : status_t LSM6DS3_ACC_GYRO_GetRawGyroData(uint8_t *buff)
...
/*******************************************************************************
* Function Name  : status_t LSM6DS3_ACC_Get_AngularRate(uint8_t *buff)
* Description    : Read GetGyroData output register
* Input          : pointer to [uint8_t]
...
status_t LSM6DS3_ACC_Get_AngularRate(void *handle, int *buff, uint8_t from_fifo)
{
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FUNC_CFG_ACCESS, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_Stamping_Time_Frame(void *handle, uint8_t newValue)
{
  uint8_t value;
  ...
  value &= (uint8_t)~LSM6DS3_ACC_GYRO_TPH_MASK;
  value |= newValue;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_Stamping_Time_Frame(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_SENSOR_SYNC_TIME, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_FIFO_Watermark(void *handle, uint16_t newValue)
{
  ...
  value &= (uint8_t)~LSM6DS3_ACC_GYRO_WTM_FIFO_CTRL1_MASK;
  value |= valueL;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_FIFO_Watermark(void *handle, uint16_t *value)
{
  uint8_t valueH, valueL;

  /* Low part from FIFO_CTRL1 */
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_CTRL1, (uint8_t *)&valueL, 1) )
    return MEMS_ERROR;
  ...
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_CTRL2, (uint8_t *)&valueH, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_CTRL2, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_DEC_FIFO_XL_val(void *handle, uint16_t newValue)
{
  switch(newValue)
  {
    case 0:
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_CTRL3, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_DEC_FIFO_G_val(void *handle, uint16_t newValue)
{
  switch(newValue)
  {
    case 0:
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_CTRL4, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_CTRL5, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_ORIENT_CFG_G, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_INT1_CTRL, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_INT2_CTRL, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL4_C, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL5_C, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL6_G, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL7_G, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL8_XL, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL9_XL, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_CTRL10_C, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_MASTER_CONFIG, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_WAKE_UP_SRC, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_TAP_SRC, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_D6D_SRC, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_STATUS_REG, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_FIFONumOfEntries(void *handle, uint16_t *value)
{
  uint8_t valueH, valueL;

  /* Low part from FIFO_STATUS1 */
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_STATUS1, (uint8_t *)&valueL, 1) )
    return MEMS_ERROR;
  ...
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_STATUS2, (uint8_t *)&valueH, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_STATUS2, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_FIFOPattern(void *handle, uint16_t *value)
{
  uint8_t valueH, valueL;

  /* Low part from FIFO_STATUS3 */
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_STATUS3, (uint8_t *)&valueL, 1) )
    return MEMS_ERROR;
  ...
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FIFO_STATUS4, (uint8_t *)&valueH, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FUNC_SRC, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_TAP_CFG1, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_TAP_THS(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_TAP_THS(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_TAP_THS_6D, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_SHOCK_Duration(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_SHOCK_Duration(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_INT_DUR2, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_QUIET_Duration(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_QUIET_Duration(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_INT_DUR2, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_DUR(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_DUR(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_INT_DUR2, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_WK_THS(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_WK_THS(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_WAKE_UP_THS, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_SLEEP_DUR(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_SLEEP_DUR(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_WAKE_UP_DUR, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_WAKE_DUR(void *handle, uint8_t newValue)
{
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_WAKE_DUR(void *handle, uint8_t *value)
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_WAKE_UP_DUR, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FREE_FALL, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_FF_Duration(void *handle, uint8_t newValue)
{
  uint8_t valueH, valueL;
  uint8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_R_FF_Duration(void *handle, uint8_t *value)
{
  uint8_t valueH, valueL;

  /* Low part from FREE_FALL reg */
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_FREE_FALL, (uint8_t *)&valueL, 1) )
    return MEMS_ERROR;
  ...
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_WAKE_UP_DUR, (uint8_t *)&valueH, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_MD1_CFG, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
{
  if( !LSM6DS3_ACC_GYRO_ReadReg(handle, LSM6DS3_ACC_GYRO_MD2_CFG, (uint8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_Get_GetTimestamp(void *handle, uint8_t *buff)
{
  uint8_t i, j, k;
  uint8_t numberOfByteForDimension;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LSM6DS3_ACC_GYRO_Get_GetStepCounter(void *handle, uint8_t *buff)
{
  uint8_t i, j, k;
  uint8_t numberOfByteForDimension;
...
/*******************************************************************************
* Function Name  : LSM6DS3_ACC_GYRO_W_PedoThreshold(void *handle, uint8_t newValue)
* Description    : Set accelerometer threshold for pedometer
* Input          : pointer to [uint8_t]
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DS3_ACC_GYRO_W_PedoThreshold(void *handle, uint8_t newValue)
{
  uint8_t value;
 ...
 */
status_t LSM6DS3_ACC_GYRO_SH_init_SI_Matrix(void *handle, uint8_t *SI_matrix)
{
  /* Open Embedded Function Register page*/
  LSM6DS3_ACC_GYRO_W_EmbeddedAccess(handle, LSM6DS3H_ACC_GYRO_FUNC_CFG_ENABLED);
...
status_t LSM6DS3_ACC_GYRO_SH0_Program(void *handle, uint8_t SlvAddr, uint8_t Reg, uint8_t len)
{
  /* Open Embedded Function Register page*/
  LSM6DS3_ACC_GYRO_W_EmbeddedAccess(handle, LSM6DS3H_ACC_GYRO_FUNC_CFG_ENABLED);
...
/* Read a remote device through I2C Sensor Hub Slave 0 */
status_t LSM6DS3_ACC_GYRO_SH0_ReadMem(void *handle, uint8_t SlvAddr, uint8_t Reg, uint8_t *Bufp, uint8_t len, uint8_t stop)
{
...
status_t LSM6DS3_ACC_GYRO_SH0_WriteByte(void *handle, uint8_t SlvAddr, uint8_t Reg, uint8_t Bufp)
{
  /* Open Embedded Function Register page*/
  LSM6DS3_ACC_GYRO_W_EmbeddedAccess(handle, LSM6DS3H_ACC_GYRO_FUNC_CFG_ENABLED);
